...
define('VIRTUAL_PATH', 'http://rattananeak.com/protosite/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/home/rattananeak/rattananeak.com/protosite/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('SUPPORT_EMAIL', 'rattana.neak@gmail..com'); # Email of site support
define('PREFIX', 'srv_'); #Prefix to add uniqueness to your DB table names.  Limits hackability, naming collisions
